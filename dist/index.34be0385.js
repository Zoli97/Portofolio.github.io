var VanillaTilt = function() {
    class t1 {
        constructor(e, i = {
            ...
            this.width = null, this.height = null, this.clientWidth = null, this.clientHeight = null, this.left = null, this.top = null, this.gammazero = null, this.betazero = null, this.lastgammazero = null, this.lastbetazero = null, this.transitionTimeout = null, this.updateCall = null, this.event = null, this.updateBind = this.update.bind(this), this.resetBind = this.reset.bind(this), this.element = e, this.settings = this.extendSettings(i), this.reverse = this.settings.reverse ? -1 : 1, this.glare = t1.isSettingTrue(this.settings.glare), this.glarePrerender = t1.isSettingTrue(this.settings["glare-prerender"]), this.fullPageListening = t1.isSettingTrue(this.settings["full-page-listening"]), this.gyroscope = t1.isSettingTrue(this.settings.gyroscope), this.gyroscopeSamples = this.settings.gyroscopeSamples, this.elementListener = this.getElementListener(), this.glare && this.prepareGlare(), this.fullPageListening && this.updateClientSize(), this.addEventListeners(), this.reset(), this.updateInitialPosition();
        }
        ...
        static init(e1, i) {
            e1 instanceof Node && (e1 = [
                e1
            ]), e1 instanceof NodeList && (e1 = [].slice.call(e1)), e1 instanceof Array && e1.forEach((e)=>{
                "vanillaTilt" in e || (e.vanillaTilt = new t1(e, i));
            });
        }
    }
...
//# sourceMappingURL=index.34be0385.js.map
